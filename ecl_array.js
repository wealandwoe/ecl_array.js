		...
		c<128 ? a.push(c) : 
			65376<c&&c<65440 ? a.push(c-65216) : 
				(c=JCT11280.indexOf((s=String.fromCharCode(c))))<0 ? a.push(129,69) : a.push(
					(m=((c<8272?c:(c=JCT11280.lastIndexOf(s)))-(c%=188))/188)<31 ? m+129 : m+193,
					c+=c<63?64:65
				)
	}
	return a;
	...
	for(i=0;i<il;i++) {
		...
		c<128 ? a.push(c) //(c-161)*94 + array[++i]-161
			: c===142 ? a.push(array[++i])
				: (c===143 && (m=-1,c=array[++i]),
						c = (k=(c-161))*94+array[++i]-161,
						m<0 ? ( // JIS X 0213
							k=(k===0||1<k&&k<5||k===7||10<k&&k<15 ? ((k+480)>>>1)-((k+1)>>3)*3 : 76<k&&k<94 ? (k+412)>>>1 : -1),
							k>0 ? a.push(k, (c%=188,c+=(c<63?64:65))) : a.push(129,69)
...
//TODO: Modified UTF-7 の実装 http://tools.ietf.org/rfc/rfc3501.txt
/*
